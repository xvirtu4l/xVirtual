                    ...
                    <div class="type-page hentry">
                        <header class="entry-header">
                            <div class="page-featured-image">
                                <img width="1920" height="1391" alt="" class="attachment-full size-full wp-post-image" src="../assets/images/products/iphone/1.jpg">
                            </div>
                            <!-- .page-featured-image -->
                            ...
                            <div class="about-features row">
                                <div class="col-md-4">
                                    <div class="single-image">
                                        <img alt="" class="" src="../assets/images/products/iphone/2.jpg">
                                    </div>
                                    <!-- .single_image -->
                                ...
                                <div class="col-md-4">
                                    <div class="single-image">
                                        <img alt="" class="" src="../assets/images/products/iphone/3.jpg">
                                    </div>
                                    <!-- .single_image -->
                                    <div class="text-block">
                                        <h2 class="align-top">Sứ mệnh của chúng tôi</h2>
                                        <p>Donec libero dolor, tincidunt id laoreet vitae,ullamcorper eu tortor. Maecenas pellentesque,dui vitae iaculis mattis, tortor nisi faucibus magna,vitae ultrices lacus purus vitae metus.</p>
                                    </div>
                                    <!-- .text_block -->
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="single-image">
                                        <img alt="" class="" src="../assets/images/products/iphone/4.jpg">
                                    </div>
                                    <!-- .single_image -->
                                    <div class="text-block">
                                        <h2 class="align-top">Lịch sử phát triển</h2>
                                        <p>Donec libero dolor, tincidunt id laoreet vitae,ullamcorper eu tortor. Maecenas pellentesque,dui vitae iaculis mattis, tortor nisi faucibus magna,vitae ultrices lacus purus vitae metus.</p>
                                    </div>
                                    <!-- .text_block -->
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-2">
                                            <div class="team-member">
                                                <img src="../assets/images/products/iphone/5.jpg" alt="">
                                                <div class="profile">
                                                    <h3>Thomas Snow
                                        ...
                                        <div class="col-sm-2">
                                            <div class="team-member circle">
                                                <img src="../assets/images/products/iphone/6.jpg" alt="">
                                                <div class="profile">
                                                    <h3>Anna Baranov
                                        ...
                                        <div class="col-sm-2">
                                            <div class="team-member circle">
                                                <img src="../assets/images/products/iphone/7.jpg" alt="">
                                                <div class="profile">
                                                    <h3>Andre Kowalsy
                                        ...
                                        <div class="col-sm-2">
                                            <div class="team-member circle">
                                                <img src="../assets/images/products/iphone/8.jpg" alt="">
                                                <div class="profile">
                                                    <h3>Pamela Doe
                                        ...
                                        <div class="col-sm-2">
                                            <div class="team-member circle">
                                                <img src="../assets/images/products/iphone/9.jpg" alt="">
                                                <div class="profile">
                                                    <h3>Susan McCain
                                        ...
                                        <div class="col-sm-2">
                                            <div class="team-member circle">
                                                <img src="../assets/images/products/iphone/11.png" alt="">
                                                <div class="profile">
                                                    <h3>Xem chi tiết
