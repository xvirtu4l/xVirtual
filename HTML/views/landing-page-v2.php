...
<div id="page" class="hfeed site">
    <header id="masthead" class="site-header header-v6" style="background-image: none; ">
        <div class="col-full desktop-only">
            <div class="techmarket-sticky-wrap">
                <div class="row">
                    ...
                    <!-- /.site-branding -->
                    <!-- ============================================================= End Header Logo ============================================================= -->
                    <a role="button" class="header-action-btn" href="shop.php">
                        Go to TechMarket Shop <i class="tm tm-long-arrow-right"></i>
                    </a>
                </div>
                <!-- /.row -->
            </div>
                        ...
                        <div class="section-media-single-banner" id="section-media-single-banner1">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <!-- .description -->
                                    <a href="shop.php" class="button">Show Products</a>
                                </div>
                                <!-- .media-body -->
                            </div>
                            <!-- .media -->
                                    ...
                                    <div class="woocommerce columns-4">
                                        <div class="products">
                                            <div class="product-featured product">
                                                <a href="single-product-fullwidth.php" class="woocommerce-LoopProduct-link woocommerce-loop-product__link">
                                                    <img width="224" height="197" src="assets/images/products/1.jpg" class="attachment-shop_catalog size-shop_catalog wp-post-image" alt="">
                                                    <span class="price">
                                            ...
                                            <div class="product-featured product">
                                                <a href="single-product-fullwidth.php" class="woocommerce-LoopProduct-link woocommerce-loop-product__link">
                                                    <img width="224" height="197" src="assets/images/products/2.jpg" class="attachment-shop_catalog size-shop_catalog wp-post-image" alt="">
                                                    <span class="price">
                                                                <span class="woocommerce-Price-amount amount">
                                                                    <span class="woocommerce-Price-currencySymbol">$</span>730.00</span>
                                                            </span>
                                            ...
                                            <div class="product-featured product">
                                                <a href="single-product-fullwidth.php" class="woocommerce-LoopProduct-link woocommerce-loop-product__link">
                                                    <img width="224" height="197" src="assets/images/products/3.jpg" class="attachment-shop_catalog size-shop_catalog wp-post-image" alt="">
                                                    <span class="price">
                                                                <span class="woocommerce-Price-amount amount">
                                                                    <span class="woocommerce-Price-currencySymbol">$</span>730.00</span>
                                                            </span>
                                            ...
                                            <div class="product-featured product">
                                                <a href="single-product-fullwidth.php" class="woocommerce-LoopProduct-link woocommerce-loop-product__link">
                                                    <img width="224" height="197" src="assets/images/products/4.jpg" class="attachment-shop_catalog size-shop_catalog wp-post-image" alt="">
                                                    <span class="price">
                                                                <span class="woocommerce-Price-amount amount">
                                                                    <span class="woocommerce-Price-currencySymbol">$</span>730.00</span>
                                                            </span>
                                            ...
                                            <div class="product-featured product">
                                                <a href="single-product-fullwidth.php" class="woocommerce-LoopProduct-link woocommerce-loop-product__link">
                                                    <img width="224" height="197" src="assets/images/products/5.jpg" class="attachment-shop_catalog size-shop_catalog wp-post-image" alt="">
                                                    <span class="price">
                                                                <span class="woocommerce-Price-amount amount">
                                                                    <span class="woocommerce-Price-currencySymbol">$</span>730.00</span>
                                                            </span>
                                            ...
                                            <div class="product-featured product">
                                                <a href="single-product-fullwidth.php" class="woocommerce-LoopProduct-link woocommerce-loop-product__link">
                                                    <img width="224" height="197" src="assets/images/products/6.jpg" class="attachment-shop_catalog size-shop_catalog wp-post-image" alt="">
                                                    <span class="price">
                                                                <span class="woocommerce-Price-amount amount">
                                                                    <span class="woocommerce-Price-currencySymbol">$</span>730.00</span>
                                                            </span>
                                            ...
                                            <div class="product-featured product">
                                                <a href="single-product-fullwidth.php" class="woocommerce-LoopProduct-link woocommerce-loop-product__link">
                                                    <img width="224" height="197" src="assets/images/products/7.jpg" class="attachment-shop_catalog size-shop_catalog wp-post-image" alt="">
                                                    <span class="price">
                                                                <span class="woocommerce-Price-amount amount">
                                                                    <span class="woocommerce-Price-currencySymbol">$</span>730.00</span>
                                                            </span>
                                            ...
                                            <div class="product-featured product">
                                                <a href="single-product-fullwidth.php" class="woocommerce-LoopProduct-link woocommerce-loop-product__link">
                                                    <img width="224" height="197" src="assets/images/products/8.jpg" class="attachment-shop_catalog size-shop_catalog wp-post-image" alt="">
                                                    <span class="price">
                                                                <span class="woocommerce-Price-amount amount">
                                                                    <span class="woocommerce-Price-currencySymbol">$</span>730.00</span>
                                                            </span>
