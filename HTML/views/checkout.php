                        ...
                        <div class="type-page hentry">
                            <div class="entry-content">
                                <div class="woocommerce">
                                    <div class="woocommerce-info">Khách hàng quen? <a data-toggle="collapse" href="#login-form" aria-expanded="false" aria-controls="login-form" class="showlogin">Bấm vào đây để đăng nhập lại</a>
                                    </div>
                                    ...
                                    <!-- .collapse -->
                                    <div class="woocommerce-info">Có mã giảm giá?<a data-toggle="collapse" href="#checkoutCouponForm" aria-expanded="false" aria-controls="checkoutCouponForm" class="showlogin">Nhấp vào đây để nhập mã của bạn</a>
                                    </div>
                                                    ...
                                                    <div class="woocommerce-billing-fields__field-wrapper-outer">
                                                        <div class="woocommerce-billing-fields__field-wrapper">
                                                            ...
                                                            <p id="billing_postcode_field" class="form-row form-row-wide address-field validate-postcode validate-required" data-o_class="form-row form-row form-row-last address-field validate-required validate-postcode">
                                                                <label class="" for="billing_postcode">Zipcode
                                                                    <abbr title="required" class="required">*</abbr>
                                                                </label>
                                                    ...
                                                    <div class="shipping_address collapse" id="shipping-address">
                                                        <div class="woocommerce-shipping-fields__field-wrapper">
                                                            ...
                                                            <p id="shipping_last_name_field" class="form-row form-row-last validate-required">
                                                                <label class="" for="shipping_last_name">Họ
                                                                    <abbr title="required" class="required">*</abbr>
                                                                </label>
                                                            ...
                                                            <p id="shipping_state_field" class="form-row form-row-wide address-field validate-state woocommerce-invalid woocommerce-invalid-required-field validate-required" data-o_class="form-row form-row-wide address-field validate-required validate-state woocommerce-invalid woocommerce-invalid-required-field">
                                                                <label class="" for="shipping_state">Tỉnh
                                                                    <abbr title="required" class="required">*</abbr>
                                                                </label>
                                                            ...
                                                            <p data-priority="90" id="shipping_postcode_field" class="form-row form-row-wide address-field validate-postcode validate-required" data-o_class="form-row form-row-wide address-field validate-required validate-postcode">
                                                                <label class="" for="shipping_postcode">Zipcode
                                                                    <abbr title="required" class="required">*</abbr>
                                                                </label>
                                                ...
                                                <table class="shop_table woocommerce-checkout-review-order-table">
                                                    ...
                                                    <tr class="cart_item">
                                                        <td class="product-name">
                                                            <strong class="product-quantity">1 ×</strong> Iphone 14 pro max 256GB&nbsp;
                                                        </td>
                                                    ...
                                                    <tr class="cart_item">
                                                        <td class="product-name">
                                                            <strong class="product-quantity">1 ×</strong> Iphone 11 &nbsp;
                                                        </td>
                                                        <td class="product-total">
                                                                        <span class="woocommerce-Price-amount amount">
                                                    ...
                                                    <tr class="cart_item">
                                                        <td class="product-name">
                                                            <strong class="product-quantity">1 ×</strong> Iphone 15 pro max&nbsp;
                                                        </td>
                                                        <td class="product-total">
                                                                        <span class="woocommerce-Price-amount amount">
                                                    ...
                                                    <tr class="cart_item">
                                                        <td class="product-name">
                                                            <strong class="product-quantity">1 ×</strong> Iphone 13&nbsp;
                                                        </td>
                                                        <td class="product-total">
                                                                        <span class="woocommerce-Price-amount amount">
                                                                            <span class="woocommerce-Price-currencySymbol"></span>25.000.000đ</span>
                                                    ...
                                                    <tr class="cart-subtotal">
                                                        ...
                                                        <td>
                                                                        <span class="woocommerce-Price-amount amount">
                                                                            <span class="woocommerce-Price-currencySymbol"></span>100.000.000đ</span>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <div class="form-row place-order">
                                                        <p class="form-row terms wc-terms-and-conditions woocommerce-validated">
                                                            <label class="woocommerce-form__label woocommerce-form__label-for-checkbox checkbox">
                                                                ...
                                                                <span>Tôi đã đọc và chấp nhận <a class="woocommerce-terms-and-conditions-link" href="terms-and-conditions.php">điều khoản và dịch vụ</a></span>
                                                                <span class="required">*</span>
                                                            </label>
                                                            <input type="hidden" value="1" name="terms-field">
                                                        </p>
                                                        <a href="order-received.php" class="button wc-forward text-center">Đặt hàng</a>
                                                    </div>
                                                </div>
