                        ...
                        <div class="type-page hentry">
                            <header class="entry-header">
                                <div class="page-header-caption">
                                    ...
                                    <p class="entry-subtitle">Thỏa Thuận này đã được sửa đổi lần cuối vào ngày 18 tháng 2 năm 2024</p>
                                </div>
                            </header>
                            <!-- .entry-header -->
                            <div class="entry-content">
                                ...
                                <div class="row faq-first-row">
                                    <div class="col-md-6">
                                        <div class="text-block">
                                            <h3 class="faq-title">Có Phương Pháp Vận Chuyển Nào Được Sử Dụng?</h3>
                                    ...
                                    <div class="col-md-6">
                                        <div class="text-block">
                                            <h3 class="faq-title">Có Phương Thức Vận Chuyển Nào Được Sử Dụng?</h3>
                                            <div class="text-content">
                                                <p>Nullam dignissim elit ut urna rutrum, a fermentum mi auctor. Mauris efficitur magna orci, et dignissim lacus
                                                    <br> scelerisque sit amet. Proin malesuada tincidunt nisl ac commodo. Vivamus eleifend porttitor ex sit amet suscipit. Vestibulum at ullamcorper lacus, vel facilisis arcu. Aliquam erat volutpat.</p>
                                            </div>
                                ...
                                <div class="row faq-second-row">
                                    <div class="col-md-6">
                                        <div class="text-block">
                                            <h3 class="faq-title">Làm Thế Nào Để Theo Dõi Đơn Hàng Của Tôi?</h3>
                                            <div class="text-content">
                                    ...
                                    <div class="col-md-6">
                                        <div class="text-block">
                                            <h3 class="faq-title">Tôi Có Cần Một Tài Khoản Để Đặt Hàng Không?</h3>
                                            <div class="text-content">
                                ...
                                <!-- .row -->
                                <h2 class="faq-title-v2">Các câu hỏi thường gặp</h2>
                                <div class="faq-subtitle">Thỏa Thuận này đã được sửa đổi lần cuối vào ngày 18 tháng 2 năm 2024.</div>
                                        ...
                                        <div class="card-header" role="tab" id="headingOne">
                                            <h5 class="mb-0">
                                                <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                                    <i class="icon"></i>
                                                  Có Phương Pháp Vận Chuyển Nào Được Sử Dụng?
                                        ...
                                        <div class="card-header" role="tab" id="headingFive">
                                            <h5 class="mb-0">
                                                <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
                                                    <i class="icon"></i>
                                                  Tôi Nên Liên Hệ Với Ai Nếu Tôi Có Bất Kỳ Thắc Mắc Nào?
                                                </a>
                                            </h5>
                                        </div>
                                        <!-- .card-header -->
