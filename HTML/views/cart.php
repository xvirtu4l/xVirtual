                                                ...
                                                <tr>
                                                    ...
                                                    <td class="product-thumbnail">
                                                        <a href="single-product-fullwidth.php">
                                                            <img width="180" height="180" alt="" class="wp-post-image" src="single-product-fullwidth.php">
                                                        </a>
                                                    </td>
                                                    <td data-title="Product" class="product-name">
                                                        <div class="media cart-item-product-detail">
                                                            ...
                                                            <div class="media-body align-self-center">
                                                                <a href="single-product-fullwidth.php">55" KU6470 6 Series UHD  Crystal Colour HDR Smart TV</a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td data-title="Product" class="product-name">
                                                        <div class="media cart-item-product-detail">
                                                            ...
                                                            <div class="media-body align-self-center">
                                                                <a href="single-product-fullwidth.php">4K Action Cam GPS</a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td data-title="Price" class="product-price">
                                                ...
                                                <tr>
                                                    ...
                                                    <td data-title="Product" class="product-name">
                                                        <div class="media cart-item-product-detail">
                                                            ...
                                                            <div class="media-body align-self-center">
                                                                <a href="single-product-fullwidth.php">Bluetooth on-ear PureBass Headphones</a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td data-title="Price" class="product-price">
                                        ...
                                        <div class="cart-collaterals">
                                            <div class="cart_totals">
                                                ...
                                                <div class="wc-proceed-to-checkout">
                                                    ...
                                                    <a class="checkout-button button alt wc-forward" href="checkout.php">
                                                        Proceed to checkout</a>
                                                    <a class="back-to-shopping" href="shop.php">Back to Shopping</a>
                                                </div>
                                                <!-- .wc-proceed-to-checkout -->
                                            </div>
                                            <!-- .cart_totals -->
