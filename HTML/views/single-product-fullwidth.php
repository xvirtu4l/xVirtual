    ...
    <div class="col-full">
      <div class="row">
        <nav class="woocommerce-breadcrumb">
          ...
          <span class="delimiter">
                                <i class="tm tm-breadcrumbs-arrow-right"></i>
                            </span>Điện thoại iPhone 14 Plus 256GB
        </nav>
                ...
                <div class="product-images-wrapper thumb-count-4">
                                            <span class="onsale">-
                                                <span class="woocommerce-Price-amount amount">
                                                    <span class="woocommerce-Price-currencySymbol"></span>35.000.000đ</span>
                                            </span>
                  <!-- .onsale -->
          ...
          <div class="woocommerce columns-5">
            <div class="products">
              <div class="landscape-product product">
                <a class="woocommerce-LoopProduct-link" href="single-product-fullwidth.php">
                  <div class="media">
                    <img class="wp-post-image" src="../assets/images/products/iphone/apple-watch-se-2022-44mm-vien-nhom-den-xanh-1.jpg" alt="">
                    <div class="media-body">
                                                    <span class="price">
                                                        <ins>
                                                            <span class="amount"> </span>
